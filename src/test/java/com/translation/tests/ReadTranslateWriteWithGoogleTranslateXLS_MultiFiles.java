...
public class ReadTranslateWriteWithGoogleTranslateXLS_MultiFiles {
    ...
    public static final File sourceFile= new File("D:\\xlsx\\Nov15_2021\\ChineseDocs\\Altay.xls"); // read from
